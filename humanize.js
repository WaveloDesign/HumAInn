...
• Ποίκιλε μήκος: μερικές σύντομες, μερικές μακριές
• Πρόσθεσε φυσικές μεταβάσεις ("Στην πράξη όμως", "Αξίζει να σημειωθεί")
• ΑΠΑΓΟΡΕΥΟΝΤΑΙ: αποτελεί, διαδραματίζει, εύρυθμη, εν κατακλείδι, ως εκ τούτου, θεμελιώδης, εν λόγω, αναδεικνύεται, ιδιαίτερη σημασία, ενισχύει, επιπροσθέτως, ωστόσο, εντούτοις
